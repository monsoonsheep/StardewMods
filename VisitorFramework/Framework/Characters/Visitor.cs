...
using static VisitorFramework.Framework.Characters.VisitorState;
...
namespace VisitorFramework.Framework.Characters
{
    ...
    public partial class Visitor : NPC
    {
        ...
        [XmlIgnore] 
        internal NetEnum<VisitorState> State = new(MovingToConvene);

        protected int conveneWaitingTimer;
        protected int lookAroundTimer;

        [XmlIgnore] 
        internal Point ConvenePoint;
        ...
        internal event Action<Visitor> OnLeaveFarm;
        internal event LerpEnd OnSitDown;
        internal event LerpEnd OnGetUp;
        ...
        public override string ToString()
        {
            return $"[Visitor] \n"
                   ...
                   + $"Convene timer: {conveneWaitingTimer} \n"
                   + $"State: {State} \n";
        }
    }
}