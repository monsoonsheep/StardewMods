...
namespace VisitorFramework.Framework.UI
{
    public sealed class CafeConfigPage : IClickableMenu
    {
        ...
        public CafeConfigPage(int x, int y, int width, int height) : base(x, y, width, height) 
        {
            ...
            this.options.Add(new OptionTimeSet(I18n.Menu_OpeningTime(), CafeManager.OpeningTime, 0700, 1800, (v) => CafeManager.OpeningTime = v));
            this.options.Add(new OptionTimeSet(I18n.Menu_ClosingTime(), CafeManager.ClosingTime, 1100, 2500, (v) => CafeManager.ClosingTime = v));
        }
